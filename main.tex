...
\rhead{\includegraphics[width=\textwidth,height=1.5cm,keepaspectratio]{imagenes/02-imagen-cabecera.png}} % Utiliza una imagen de ejemplo
...
\fancypagestyle{plain}{
    \rhead{\includegraphics[width=\textwidth,height=1.5cm,keepaspectratio]{imagenes/02-imagen-cabecera.png}} 
    \rfoot{\thepage}
}
...
\begin{titlepage}
    ...
    \begin{minipage}{0.5\textwidth}
        \includegraphics[width=0.8\textwidth]{imagenes/01-imagen-portada.png} % reemplaza 'example-image' por el nombre de tu imagen
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \textbf{Alumno:} \\
...
\input{chapter/001-agradecimientos/001-agradecimientos.tex.}
...
\input{chapter/002-plan-de-trabajo/002-plan-de-trabajo.tex.} % Importa el contenido del archivo 002-plan-de-trabajo.tex

\section{Problema a resolver.}
\input{chapter/002-plan-de-trabajo/sections/002-01-problema-resolver.tex} 

\section{Objetivos.}
\input{chapter/002-plan-de-trabajo/sections/002-02-objetivos.tex} 
...
\input{chapter/002-plan-de-trabajo/sections/002-04-listado-de-tareas.tex} 

\section{Planificación temporal de las tareas.}
\input{chapter/002-plan-de-trabajo/sections/002-05-planificacion-temporal-de-las-tareas.tex} 

\section{Revisión del estado del arte de la informática forense.}
\input{chapter/002-plan-de-trabajo/sections/002-06-revision-del-estado-del-arte-de-la-informatica-forense.tex} 

\chapter{Extremos del análisis y previsión de pruebas técnicas.}
\input{chapter/003-extremos-del-analisis-y-prevision-de-pruebas-tecnicas/003-extremos-del-analisis-y-prevision-de-pruebas-tecnicas.tex}

\section{Propuesta de extremos.}
\input{chapter/003-extremos-del-analisis-y-prevision-de-pruebas-tecnicas/sections/003-01-propuesta-de-extremos.tex}

\section{Previsión de pruebas técnicas.}
\input{chapter/003-extremos-del-analisis-y-prevision-de-pruebas-tecnicas/sections/003-02-prevision-de-pruebas-tecnicas.tex} 

\chapter{Análisis de la memoria RAM.}
\input{chapter/004-analisis-de-la-memoria-ram/004-analisis-de-la-memoria-ram.tex}
